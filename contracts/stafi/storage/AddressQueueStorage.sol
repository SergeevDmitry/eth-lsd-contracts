...
//     ) StafiBase(0, _stafiStorageAddress) {
//         version = 1;
//     }

//     // The number of items in a queue
//     function getLength(bytes32 _key) public view override returns (uint256) {
...
//         uint256 index = getUint(keccak256(abi.encodePacked(_key, ".start")))
//             .add(_index);
//         if (index >= capacity) {
...
//         if (index != -1) {
//             index -= int256(
//                 getUint(keccak256(abi.encodePacked(_key, ".start")))
//             );
//             if (index < 0) {
...
//         external
//         override
//         // onlyLatestContract("addressQueueStorage", address(this))
...
//             keccak256(abi.encodePacked(_key, ".item", start))
//         );
//         start = start.add(1);
//         if (start >= capacity) {
...
//                 keccak256(abi.encodePacked(_key, ".item", lastIndex))
//             );
//             setAddress(
