...
// contract StafiDistributor is
//     StafiBase,
//     IStafiEtherWithdrawer,
//     IStafiDistributor
// {
//     // Libs
...
//             getUint(
//                 keccak256(
//                     abi.encodePacked("stafiDistributor.merkleRoot.dealedEpoch")
//                 )
//             );
//     }
...
//         return
//             getBytes32(
//                 keccak256(abi.encodePacked("stafiDistributor.merkleRoot"))
//             );
//     }
...
//         require(
//             _dealedHeight > getDistributeFeeDealedHeight(),
...
//         if (needExe) {
//             IStafiFeePool feePool = IStafiFeePool(
//                 getContractAddress("stafiFeePool")
//             );
//             IStafiUserDeposit stafiUserDeposit = IStafiUserDeposit(
//                 getContractAddress("stafiUserDeposit")
//             );
//             IStafiEther stafiEther = IStafiEther(
//                 getContractAddress("stafiEther")
//             );
...
//             if (_userAmount > 0) {
//                 stafiUserDeposit.recycleDistributorDeposit{
//                     value: _userAmount
//                 }();
//             }
...
//         require(
//             _dealedHeight > getDistributeSuperNodeFeeDealedHeight(),
//             "height already dealed"
//         );
...
//         if (needExe) {
//             IStafiFeePool feePool = IStafiFeePool(
//                 getContractAddress("stafiSuperNodeFeePool")
//             );
//             IStafiUserDeposit stafiUserDeposit = IStafiUserDeposit(
//                 getContractAddress("stafiUserDeposit")
//             );
...
//         require(
//             _dealedHeight > getDistributeSlashDealedHeight(),
//             "height already dealed"
//         );

//         bytes32 proposalId = keccak256(
//             abi.encodePacked("distributeSlashAmount", _dealedHeight, _amount)
//         );
//         bool needExe = _voteProposal(proposalId);
...
//         bytes32 proposalId = keccak256(
//             abi.encodePacked("setMerkleRoot", _dealedEpoch, _merkleRoot)
//         );
//         bool needExe = _voteProposal(proposalId);
...
//             getTotalClaimedReward(_account)
//         );
//         uint256 claimableDeposit = _totalExitDepositAmount.sub(
//             getTotalClaimedDeposit(_account)
//         );
...
//         );
//         require(
//             MerkleProof.verify(_merkleProof, getMerkleRoot(), node),
//             "invalid proof"
//         );
...
//         setUint(
//             keccak256(
//                 abi.encodePacked("stafiDistributor.distributeFee.dealedHeight")
//             ),
//             _dealedHeight
//         );
//     }
...
//             abi.encodePacked("stafiDistributor.proposal.key", _proposalId)
//         );
