...
//         uint256 totalMissingAmount = totalMissingAmountForWithdraw.add(
//             ethAmount
//         );
...
//         withdrawalAtIndex[willUseWithdrawalIndex] = Withdrawal({
//             _address: msg.sender,
//             _amount: ethAmount
//         });
...
//             require(
//                 withdrawIndex <= maxClaimableWithdrawIndex,
//                 "not claimable"
//             );
//             require(
...
//                 withdrawalAtIndex[withdrawIndex]._amount
//             );
//         }
...
//         external
//         override
//         onlyLatestContract("stafiWithdraw", address(this))
//         onlyTrustedNode(msg.sender)
//     {
//         require(
//             _dealedHeight > latestDistributeHeight,
//             "height already dealed"
//         );
//         require(
//             _maxClaimableWithdrawIndex < nextWithdrawIndex,
//             "withdraw index over"
//         );
//         require(
...
//             } else {
//                 mvAmount = 0;
//                 totalMissingAmountForWithdraw = totalMissingAmountForWithdraw
//                     .sub(_userAmount);
//             }
...
//                 getContractAddress("stafiDistributor")
//             );
//             uint256 nodeAndPlatformAmount = _nodeAmount.add(_platformAmount);
//             if (nodeAndPlatformAmount > 0) {
//                 stafiDistributor.distributeWithdrawals{
//                     value: nodeAndPlatformAmount
//                 }();
//             }
...
//     {
//         bytes32 proposalId = keccak256(
//             abi.encodePacked("reserveEthForWithdraw", _withdrawCycle)
//         );
//         bool needExe = _voteProposal(proposalId);
...
//                 withdrawLimitPerCycle.mul(3).div(20 ether),
//             "length not match"
//         );
//         require(
...
//         );
//         require(
//             ejectedValidatorsAtCycle[_withdrawCycle].length == 0,
//             "already dealed"
//         );
...
//         require(
//             totalWithdrawAmountAtCycle[currentCycle].add(ethAmount) <=
//                 withdrawLimitPerCycle,
//             "reach cycle limit"
//         );
//         require(
//             userWithdrawAmountAtCycle[msg.sender][currentCycle].add(
//                 ethAmount
//             ) <= userWithdrawLimitPerCycle,
//             "reach user limit"
//         );

//         totalWithdrawAmountAtCycle[currentCycle] = totalWithdrawAmountAtCycle[
//             currentCycle
//         ].add(ethAmount);
//         userWithdrawAmountAtCycle[msg.sender][
//             currentCycle
//         ] = userWithdrawAmountAtCycle[msg.sender][currentCycle].add(ethAmount);
...
//             abi.encodePacked("stafiWithdraw.proposal.key", _proposalId)
//         );
...
//             stafiNodeManager.getTrustedNodeCount().mul(threshold)
//         ) {
//             return true;
//         }
//         return false;
